...
class TuckBoxCompositeService
{
    ...
    // Zone 1 — Top flap
    private const Z1 = ['top' => 0.095, 'left' => 0.08, 'w' => 0.36, 'h' => 0.11];

    // Zone 2 — Front face
    private const Z2 = ['top' => 0.43, 'left' => 0.10, 'w' => 0.36, 'h' => 0.42];

    // Zone 3 — Right side strip
    private const Z3 = ['top' => 0.28, 'left' => 0.41, 'w' => 0.08, 'h' => 0.45];
    ...
    private function getZone2Layout(int $total): array
    {
        ...
        return [
            ...
            ['i' => 1, 'x' => -28, 'y' =>  10, 'scale' => 0.78, 'size' => 0.80, 'z' => 2, 'clip' => '0% 27% 55% 28%'],
            ['i' => 2, 'x' =>  26, 'y' =>  10, 'scale' => 0.78, 'size' => 0.80, 'z' => 2, 'clip' => '0% 27% 55% 25%'],
            ['i' => 0, 'x' => 0,   'y' =>  -10, 'scale' => 1,    'size' => 0.99, 'z' => 3, 'clip' => '0% 25% 50% 25%'],
        ];
    }
